...
ROUND_TIME=10
NUM_PEER=5
NODE_DISHONEST_REPLICA_VALUES=(5 8 10 13 15)
...
for i in {6..6}; do
    for TAU in "${TAU_VALUES[@]}"; do
        for NODE_DISHONEST_REPLICAS in "${NODE_DISHONEST_REPLICA_VALUES[@]}"; do
            ...
            export SCP_PATH="~/logs/${TAU}tau/${NODE_DISHONEST_REPLICAS}_${DISHONEST_BROADCAST_CREATED_BLOCK}_${DISHONEST_BROADCAST_RECEIVED_BLOCK}_${i}"
